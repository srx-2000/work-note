...
def get_path_value_dict(json_data, match_str, is_value=False):
    if is_value:
...
target_key = "finalPrice"
# target_key = 43900
# for k, v in get_path_value_dict(json_data, target_key, is_value=True).items():
for k, v in get_path_value_dict(json_data, target_key, is_value=False).items():
    # print(k, v)
    print("key=>", k)
    print("value=>", v)
